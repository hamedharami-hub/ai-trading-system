...
> **وضعیت تاریخی:** این تقسیم‌بندی سیزده‌مرحله‌ای با تصمیم `DEC-069` از نظر مدیریت اجرا جای خود را به [نقشه راه فشرده شش‌مرحله‌ای](consolidated-roadmap-fa.md) داده است. الزامات، خطرها و دروازه‌های ایمنی این سند همچنان معتبرند و حذف نشده‌اند؛ وضعیت‌های اجرایی این فایل مرجع وضعیت جاری نیستند.
