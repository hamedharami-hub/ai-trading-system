...
- مرحله فعال: مرحله ۳، AI آفلاین Windows و Android، با `DEC-077` مجاز و برای بازبینی مالک آماده شده است؛ build native هر دو ABI موفق است و benchmark دستگاه فیزیکی هنوز باقی مانده است.
- مراحل ۴ تا ۶: شروع نشده
