...
> **به‌روزرسانی وضعیت:** پس از تهیه این بسته، مالک نقشه شش‌مرحله‌ای، استفاده انتخابی از کد Antigravity، تجربه هم‌ارز Windows/Android، Firebase/Vercel و AI آفلاین آینده را در `DEC-069` تا `DEC-073` تصویب کرد. برای وضعیت جاری ابتدا `consolidated-roadmap-fa.md` و `antigravity-recovery-audit.md` خوانده شوند.
