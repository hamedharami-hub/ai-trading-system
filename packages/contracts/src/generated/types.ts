 ...
 * Generated at: 2026-08-30T09:39:01.066Z
 */
...
/**
 * RFC 3339 / ISO 8601 UTC timestamp format.
 *
 * This interface was referenced by `Primitives`'s JSON-Schema
...
/**
 * Canonical UUID string (UUIDv7 for time-ordered identifiers).
 *
 * This interface was referenced by `Primitives`'s JSON-Schema
...
export type MarketId =
  "EURUSD" | "GBPUSD" | "USDJPY" | "AUDUSD" | "USDCAD" | "USDCHF" | "NZDUSD" | "XAUUSD" | "BTCUSDT" | "ETHUSDT";
/**
...
export interface ExecutionReportPayload {
   ...
   * Canonical market identifier according to DEC-053.
   */
  symbol: "EURUSD" | "GBPUSD" | "USDJPY" | "AUDUSD" | "USDCAD" | "USDCHF" | "NZDUSD" | "XAUUSD" | "BTCUSDT" | "ETHUSDT";
  /**
   * Order and position direction.
   */
  side: "BUY" | "SELL";
   ...
   * Lifecycle status of an order according to DEC-051.
   */
  status: "PENDING_NEW" | "NEW" | "PARTIALLY_FILLED" | "FILLED" | "CANCELLED" | "REJECTED" | "EXPIRED";
  /**
   * Non-negative arbitrary-precision decimal string.
   */
